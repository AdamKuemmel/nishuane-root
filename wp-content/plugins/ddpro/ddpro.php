...
if (!class_exists('ddp_AM_License_Menu')) {
    ...
    ddp_AM_License_Menu::instance(__FILE__, 'Divi Den Pro Membership', '5.2.6', 'plugin', 'https://wp-den.com/');
}
...
//        For April 27
        ...
        if (strpos($post_content, 'grace_person_parking_about_v2')) {
            add_post_meta($post_id, 'ddp-css-grace', 'grace-person-parking-v2');
        }
        ...
        if (strpos($post_content, 'grace_persons_saturn')) {
            add_post_meta($post_id, 'ddp-css-grace', 'grace-persons-saturn');
        }
        ...
        if (strpos($post_content, 'grace_footer_mira')) {
            add_post_meta($post_id, 'ddp-css-grace', 'grace-footer-mira');
        }
    ...
    function ddp_register_css($post_here){
        ...
        if($post) {
            ...
            foreach ((array) get_post_meta($post->ID, 'ddp-css-grace') as $ddp_css_grace) {
                ...
                if ($ddp_css_grace == 'grace-persons-saturn') {
                    wp_enqueue_style('grace-persons-saturn', plugins_url('build/grace/css/persons/grace-person-saturn.css', __FILE__));
                } 
                ...
                if ($ddp_css_grace == 'grace-footer-mira') {
                    wp_enqueue_style('grace-footer-mira', plugins_url('build/grace/css/footers/grace-footers-mira.css', __FILE__));
                } 
        ...
        if($post) {
            ...
            if (!empty(get_post_meta($post->ID, 'ddp-css-grace'))) {
                foreach ((array) get_post_meta($post->ID, 'ddp-css-grace') as $ddp_css_grace) {
                    ...
                    if ($ddp_css_grace == 'grace-portfolio-gomeisa') {
                        wp_enqueue_script('ddp-grace-masonry-js', plugins_url('build/pegasus/js/pegasus-library.js', __FILE__));
                    ...
                    if ($ddp_css_grace == 'grace-person-founding') {
                        wp_enqueue_script('ddp-grace-gsap-jquery-js', plugins_url('build/freddie/js/gsap/gsap.min.js', __FILE__));
